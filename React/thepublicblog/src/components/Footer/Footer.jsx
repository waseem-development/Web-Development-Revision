            ...
            <div className="flex gap-3 mt-2">
              {[
                ...
                <Link
                  ...
                  to="#"
                  aria-label={label}
                  className="p-2 rounded-lg border border-default text-muted hover:text-amber hover:border-amber transition-colors cursor-pointer"
                >
            ...
            <ul className="flex flex-col gap-2.5">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    to={link.slug}
                    className="text-sm text-muted hover:text-amber transition-colors cursor-pointer"
                  >
                    {link.name}
                  </Link>
                </li>
