...
function AddPost() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <h1 className="font-display text-4xl font-semibold mb-8">Write a Post</h1>
      <p className="text-muted">Post form will appear here.</p>
    </div>
  );
}
...
function EditPost() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <p className="text-muted">Edit form will appear here.</p>
    </div>
  );
}
